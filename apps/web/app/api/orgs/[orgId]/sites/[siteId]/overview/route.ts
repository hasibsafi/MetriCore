...
import { getOverviewSnapshot } from "../../../../../../../src/services/overview-service";
...
export async function GET(request: Request, { params }: Props) {
  try {
    ...
    const result = await getOverviewSnapshot(parsedParams.orgId, parsedParams.siteId, parsedQuery.range ?? null);
    ...
    return NextResponse.json({ message: "Unable to fetch overview snapshot." }, { status: 500 });
  }
}
