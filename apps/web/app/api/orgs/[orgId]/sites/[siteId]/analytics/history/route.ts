...
import { getAnalyticsHistory } from "../../../../../../../../src/services/analytics-visualization-service";
...
export async function GET(request: Request, { params }: Props) {
  try {
    ...
    const result = await getAnalyticsHistory(parsedParams.orgId, parsedParams.siteId, parsedQuery.range ?? null);
    ...
    return NextResponse.json({ message: "Unable to fetch analytics history." }, { status: 500 });
  }
}
