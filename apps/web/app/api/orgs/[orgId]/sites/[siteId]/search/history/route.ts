...
import { getSearchHistory } from "../../../../../../../../src/services/analytics-visualization-service";
...
export async function GET(request: Request, { params }: Props) {
  try {
    ...
    const result = await getSearchHistory(parsedParams.orgId, parsedParams.siteId, parsedQuery.range ?? null);
    ...
    return NextResponse.json({ message: "Unable to fetch search history." }, { status: 500 });
  }
}
